...
function renderPage(pageIndex, page) {
    ...
    orderedQuestions.forEach((question, index) => {
        ...
        // Get answer type
        const answerType = answerInput ? 
            ((answerInput.question_config && answerInput.question_config.question_type) || 
        ...
        // We just render directly to the main container
        if (answerInput) {
            ...
            const renderedEl = RuntimeRenderer.ElementRenderer.renderElement(container, answerInput, {
                mode: 'participant',
                insideContainer: false, // All renderers create their own container
                question: question, // Pass question for context
                questionTitle: questionTitle, // Pass title to renderer
            ...
            const questionContainerForVisibility = document.getElementById(`question-${question.id}`);
            ...
            if (isVisible) {
                ...
                if (questionContainerForVisibility) {
